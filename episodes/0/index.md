...
Цей випуск зроблено на основі [Front-end Digest № 125: «найбільш ненависна» функція CSS та «нудна» зрілість React](https://dou.ua/forums/topic/56488/) від [Olexander Smolianinov](https://dou.ua/users/dersmoll/),frontend director в[ZFORT Group](https://jobs.dou.ua/companies/zfort/). Неймовірне дякую Олександру за його труд.

Новини, які увійшли в випуск помічені ✅, решта — рекомендоване читання 📚. Я зробив таке розділення, бо їх забагато для цього формату. 
